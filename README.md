...
## 🏃‍♀️ Option 1: Local Deployment (Recommended for Windows)
...
├── data/                       # Dataset files
├── pipelines/
│   ├── deployment_pipeline.py       # Docker-based pipeline definition
│   └── local_deployment_pipeline.py # Local python-based pipeline definition
├── steps/
...
├── run_deployment.py           # Script to run Docker deployment
├── run_local_deployment.py     # Script to run Local deployment
